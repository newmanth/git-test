...
tred,tgreen,tblue,talpha=1,0.64,0,1
...
tfontsize=12
--###################################################
--main body text color${offset 15}${font Ubuntu:size=10,weight:normal}${color1}Uptime: $uptime
...
xred,xgreen,xblue,xalpha=1,1,1,0.75
